...
Run `npm run build` to build the project, then navigate to `http://localhost:3000/`. Please note that lines 35, 36 and 37 should be uncommented in the server.js file for this option!
